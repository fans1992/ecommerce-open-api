...
class AddNeedInvoiveToOrderTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('ibrand_order', function (Blueprint $table) {
            $table->string('email')->nullable()->after('mobile')->comment('邮箱');
            ...
            $table->unsignedInteger('order_agreement_id')->nullable()->after('applicant_data')->comment('服务协议');
    ...
    public function down()
    {
        Schema::table('ibrand_order', function (Blueprint $table) {
            ...
            $table->dropColumn('order_agreement_id');
