...
//        'mode'=>'local',//上传方式,local 为本地   qiniu 为七牛
        ...
        'qiniu'=>[
            'accessKey'=>env('QINIU_ACCESS_KEY', 'xxxxxxxxxxxxxxxx'),
            'secretKey'=>env('QINIU_SECRET_KEY', 'xxxxxxxxxxxxxxxx'),
            'bucket'=> env('QINIU_BUCKET', 'test'),
            'url'=> env('QINIU_DOMAIN', 'xxx.clouddn.com'),//七牛分配的CDN域名,注意带上http://
        ]
    ],
