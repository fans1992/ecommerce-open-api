...
@section('body')
    <div class="row">
        <a href="/assets/template/classification_demo.xlsx" style="margin: 10px 0;display: block;"
           target="_blank">推荐分类模板文件下载</a>

        <form method="POST" action="{{route('admin.industry.saveImportData')}}" accept-charset="UTF-8"
              id="import_form" class="form-horizontal">
            <input type="hidden" class="_token" value="{{ csrf_token() }}">
            <div class="col-md-8">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="col-sm-3 control-label">导入推荐分类：</label>
                    <div class="col-sm-9">
...
//                    mimeTypes: 'image/*'
            ...
            uploader.on('uploadSuccess', function (file, response) {
                ...
                $('.update_true').html("已上传成功请点击保存导入推荐分类");
